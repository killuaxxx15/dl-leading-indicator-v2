...
const RAW: Record<string, RawConfig> = {
  ...
  SPX_VS_200DMA: {
    ...
    note: 'Equity market is itself a leading indicator per Conference Board LEI. Ticker: ^GSPC',
  ...
  COPPER_GOLD: {
    ...
    lead_months: 3, direction: 'positive',
    baseline_mean: 0, baseline_std: 5, unit: '% vs 3M avg',
    note: 'Pro-cyclical copper vs safe-haven gold, expressed as % above/below its 3-month average. Tickers: HG=F · GC=F',
  ...
  ISM_NEW_ORDERS: {
    ...
    name: 'ISM Manufacturing New Orders', source: 'FRED',
    lead_months: 2, direction: 'positive_50',
    baseline_mean: 50, baseline_std: 5, unit: 'index',
    note: 'ISM Manufacturing New Orders diffusion index. >50 = expansion, <50 = contraction.',
    source_url: 'https://fred.stlouisfed.org/series/NAPMNOI',
    source_label: 'FRED · NAPMNOI',
  },
  LEI: {
    pillar: 'growth', group: 'growth_surveys',
  ...
  BCOM_YOY: {
    ...
    note: 'Broad commodity basket. Leads goods inflation 2-4 months. Ticker: ^BCOM (or DJP fallback)',
    source_url: 'https://finance.yahoo.com/quote/%5EBCOM/',
    source_label: 'Yahoo Finance · ^BCOM / DJP',
  },
  OIL_YOY: {
    pillar: 'inflation', group: 'inflation_commodities',
...
export const DATA_SOURCE_LINKS = [
  ...
  { label: 'ISM Mfg New Orders (FRED)', url: 'https://fred.stlouisfed.org/series/NAPMNOI', description: 'ISM Manufacturing New Orders Index' },
